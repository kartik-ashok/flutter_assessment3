    ...
    return Column(
      children: [
        InkWell(
          ...
          child: _tileItem1('Account settings', AppAssets.userRoundCogIcon),
        ),
        InkWell(
          onTap: () {},
          child: _tileItem1('Help & Feedback', AppAssets.infoIcon),
        ),
      ],
    );
  }

  Widget _tileItem1(String title, String iconPath) {
    return Padding(
